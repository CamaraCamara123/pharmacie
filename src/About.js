...
const About = () => {
  return (
    <Container className='main-row-contact'>
      <h1 className='tracking-in-expand-fwd-top' style={{fontFamily:'fantasy', color:'green'}}>A PROPOS DE NOUS</h1>
      <Row className='mt-4'>
        <Col md={6}>
          ...
          <p>
            ...
            L'ancêtre du pharmacien, l'apothicaire est repéré dès 2600 av. J.-C. à Sumer où des textes médicaux, mêlés à 
            des incantations religieuses1, sont attestés sur deux tablettes d'argile dont les cunéiformes mentionnent
          </p>
          </Container>
        </Col>
        <Col md={6}>
